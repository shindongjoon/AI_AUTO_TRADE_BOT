...
class Calculator2:
    def __init__(self, stock):
        self.citem = Stock4(stock.name, stock.close, stock.high, stock.low)

    def average(self):
        return round((self.citem.close + self.citem.high + self.citem.low) / 3, 2)


item1 = Stock4('삼성전자', 67700, 69500, 67000)
item2 = Stock4('SK하이닉스', 150000, 156000, 147000)
cal1 = Calculator2(item1)
typical_price1 = cal1.average()
print(f"{item1.name} 대표값: {typical_price1}")
cal2 = Calculator2(item2)
